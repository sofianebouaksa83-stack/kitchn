...
export function ManageGroupModal(props: ManageGroupModalProps) {
  ...
  const [renderedGroup, setRenderedGroup] =
    useState<GroupWithMembers | null>(selectedGroup);
  ...
  const invitation = useGroupInvitation({
    open,
    group,
    membersLimitReached: isMembersLimitReached,
    onInvitationSent,
  });
  const busy = manageLoading || invitation.inviteLoading;
                    ...
                    >
                      ...
                      {canManageGroups && (
                        <button
                          ...
                          disabled={busy || member.id === userId}
                        >
