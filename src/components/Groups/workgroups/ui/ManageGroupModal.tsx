    ...
    >
      {open && group && (
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center sm:p-4">
          ...
          <motion.div
            className="relative flex max-h-[92dvh] w-full flex-col overflow-hidden rounded-t-[32px] border-t border-white/10 bg-[#071127] shadow-[0_-20px_80px_rgba(0,0,0,0.55)] sm:max-w-lg sm:rounded-[28px] sm:border sm:border-white/10 sm:bg-white/[0.06] sm:ring-1 sm:ring-white/10 sm:shadow-[0_18px_70px_rgba(0,0,0,0.35)] sm:backdrop-blur-md"
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  onClick={onClose}
                  className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white/10 text-white/80 transition hover:bg-white/15"
                  title="Fermer"
                >
                  <X className="h-5 w-5" />
                </button>
              ...
              <div className="mt-5 border-t border-white/10 pt-4">
                ...
                <div className="max-h-72 space-y-2 overflow-auto pr-1">
                  {members.map((m: any) => (
                    <div
                      key={m.id}
                      className="flex items-center justify-between rounded-2xl bg-black/10 px-3 py-2 ring-1 ring-white/10"
                    >
