            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-2">Démo • Tous formats • Max {MAX_MB} MB par fichier</p>
                </div>
              </div>
                ...
                <div className="rounded-3xl bg-white/[0.06] ring-1 ring-white/10 p-5 shadow-[0_18px_60px_rgba(0,0,0,0.25)] backdrop-blur-md">
                  ...
                  {queue.length > 0 && queue.every((q) => q.status === "success") && (
                    <div className="mt-5 space-y-3">
                      ...
                      <button onClick={goToRecipes} className={`${ui.btnGhost} w-full py-3 rounded-2xl`} type="button">
                        Voir mes recettes
                      </button>
                    </div>
                  )}
