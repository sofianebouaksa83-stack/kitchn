...
export type RecipeImportExplorerMode =
  | "library"
  | "folder";
        ...
        >
          ...
          <div
            className="
              ...
              border-b
              border-white/10
              bg-[linear-gradient(180deg,rgba(30,41,59,0.92)_0%,rgba(22,32,51,0.88)_100%)]
              px-4
              backdrop-blur-xl
            "
          >
          ...
          >
            ...
            <section
              className="
                ...
                min-w-0
                flex-col
                bg-[linear-gradient(180deg,#0f172a_0%,#101a31_100%)]
              "
            >
              {/* TOOLBAR */}
              <div
              ...
              >
                ...
                >
                  <div
                    className="
                      grid
                      grid-cols-[1.5fr_110px_110px_120px]
                      gap-3
                      border-b
                      border-white/10
                      bg-white/[0.02]
                          ...
                          >
                            ...
                            <div className="text-right">
                              <button
                                ...
                                className={[
                                  "inline-flex min-w-[104px] items-center justify-center gap-2 rounded-xl border px-3 py-2 text-sm transition-all duration-200",
                                  opening
                              ...
                              >
                                {/*
                                  IMPORTANT :
                                  tout reste monté dans le DOM.
                                  On ne fait que masquer/afficher.
                                */}
                                <span
                                  className="
                                    relative
                                ...
                                >
                                  <Loader
                                    className={[
                                      "absolute inset-0 h-4 w-4 animate-spin transition-opacity",
                                      opening
                                        ? "opacity-100"
