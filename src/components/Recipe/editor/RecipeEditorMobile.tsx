            ...
            <div>
              ...
              <div className="rounded-[24px] bg-white/[0.025] ring-1 ring-white/10 p-3">
                {editor.recipeImages.length > 0 ? (
                  ...
                  <div className="h-36 w-full flex flex-col items-center justify-center gap-2 rounded-[18px] bg-white/[0.035] text-slate-300/70">
                    <ImagePlus className="h-7 w-7 text-amber-200/80" />
