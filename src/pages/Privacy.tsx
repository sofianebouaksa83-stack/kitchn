    ...
    >
      <LegalSection title="1. Données collectées">
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            Nom ou identifiant de profil, si
            disponible
          </li>

          <li>
            Données techniques nécessaires au
      ...
      <LegalSection title="2. Utilisation des données">
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            Assurer l’authentification et la
            sécurité de la plateforme
          </li>

          <li>
            Permettre l’accès aux
            fonctionnalités de Kitch’n
          </li>

          <li>
            Prévenir les abus, erreurs
            techniques et usages frauduleux
          </li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="3. Partage des données">
        <p>
          Vos données ne sont ni revendues ni
          utilisées à des fins commerciales
          par des tiers. Elles peuvent être
          traitées uniquement par des
          prestataires techniques nécessaires
          au fonctionnement du service,
          notamment pour l’hébergement,
          l’authentification, la base de
          données et le paiement.
        </p>
      </LegalSection>
      ...
      <LegalSection title="4. Conservation">
        <p>
          ...
          la durée d’activité du compte, ou le
          temps nécessaire pour répondre à des
          obligations techniques, légales ou
          de sécurité.
        </p>
      </LegalSection>
      ...
      <LegalSection title="5. Vos droits">
        <p>
          ...
          rectification ou la suppression de
          vos données personnelles, dans la
          limite des obligations légales et
      ...
      <LegalSection title="6. Contact">
        <p>
          ...
          confidentialité ou à vos données :
        </p>
